...
void calculate_chunk_CAS(int rowinc, int n, const vector<vector<int>> &matrix, vector<vector<int>> &output)
{
    while (true)
    {
...
int main()
{
    ...
    for (int i = 0; i < k; ++i)
    {
        threads.push_back(thread(calculate_chunk_CAS, rowinc, n, ref(matrix), ref(output)));
    }
